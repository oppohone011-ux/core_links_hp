          ...
          <div className={styles.headerTop}>
            <div className={styles.repoTitle}>
              <div className={styles.logoWrapper}>
                ...
                <span className={styles.hubTitle}>CORELINKS-Hub</span>
              </div>
              ...
              <article className={styles.readmeBody}>
                ...
                <div className={styles.timeline}>
                  ...
                  <div className={styles.timeItem}>
                    ...
                    <p><strong>RPA & Web Engineer / DX Architect:</strong> アメリカEC会社等でのRPAツール開発、Python動画分析、最新のNext.js 15 / Node.jsによるAIスコアリング実装。現場DXの軍師として活動。</p>
                  </div>

                  {/* --- 2016 - 2020: グローバル & EC --- */}
                  <div className={styles.timeItem}>
                    <span className={styles.timeTag}>2016 - 2020</span>
                    <p><strong>Global & EC Business:</strong> 中東ドバイにて世界万博スタッフ（なぎなたショー出演）。帰国後、個人事業主としてEC運営を極め、独自の仕入れ自動化に着手。</p>
                  </div>

                  {/* --- 2011 - 2015: 規律 & 自衛隊 --- */}
                  <div className={styles.timeItem}>
                    <span className={styles.timeTag}>2011 - 2015</span>
                    <p><strong>JSDF (自衛隊):</strong> 陸上自衛隊 車両・武器の整備に従事。極限状態での規律と、止まることを許されないシステムの保守概念を習得。</p>
                  </div>

                  {/* --- 2005 - 2010: 原点 & 品質管理 --- */}
                  <div className={styles.timeItem}>
                    <span className={styles.timeTag}>2005 - 2010</span>
                    <p><strong>Quality Assurance (自動車会社/自動車照明会社):</strong> 自動車・部品製造の最前線にて品質管理に従事。19歳でExcel VBAによる測定データ分析システムを自ら構築。エンジニア人生の原点。</p>
                  </div>
                </div>
              </article>
            </div>
          ...
          <aside className={styles.sideCol}>
            ...
            <div className={styles.sideBlock}>
              ...
              <ul className={styles.langList}>
                <li><span className={styles.dotField}>●</span> Field Quality Control</li>
                <li><span className={styles.dotTs}>●</span> Full-Stack Web (v15)</li>
